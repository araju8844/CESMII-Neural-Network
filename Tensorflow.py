...
def initialize_parameters():
    ...
    W1 = tf.get_variable(
        "W1", [6, 120], initializer=tf.contrib.layers.xavier_initializer())
    b1 = tf.get_variable("b1", [6, 1], initializer=tf.zeros_initializer())
    W2 = tf.get_variable(
        "W2", [3, 6], initializer=tf.contrib.layers.xavier_initializer())
    b2 = tf.get_variable("b2", [3, 1], initializer=tf.zeros_initializer())
    W3 = tf.get_variable(
        "W3", [1, 3], initializer=tf.contrib.layers.xavier_initializer())
...
def model(X_train, Y_train, X_test, Y_test, learning_rate=0.0001,
    ...
    # to be able to rerun the model without overwriting                                    # to keep consistent results
